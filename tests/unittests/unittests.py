...
class TestAdd(TestCase):
    ...
    def test_medium_add(self):
        # TODO: YOUR CODE HERE
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(50, 50, seed=8)
    ...
    def test_large_add(self):
        # TODO: YOUR CODE HERE
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(1000, 1000, seed=4)
...
class TestAbs(TestCase):
    ...
    def test_large_abs(self):
        dp_mat, nc_mat = rand_dp_nc_matrix(1030, 1030, seed=0)
        is_correct, speed_up = compute([dp_mat], [nc_mat], "abs")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestMul(TestCase):
    ...
    def test_medium_mul(self):
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(100, 100, seed=1)
    ...
    def test_large_mul(self):
        ...
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(1000, 1000, seed=3)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "mul")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
    
    def test_non_square_mul(self):
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(2, 5, seed=1)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(5, 2, seed=3)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "mul")
        self.assertTrue(is_correct)
        print_speedup(speed_up)

    def test_no_same_outer_vals(self):
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(7, 2, seed=1)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(2, 15, seed=3)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "mul")
        self.assertTrue(is_correct)
        print_speedup(speed_up)

    def test_no_same_outer_vals_med(self):
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(183, 223, seed=1)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(223, 472, seed=3)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "mul")
        self.assertTrue(is_correct)
        print_speedup(speed_up)

    def test_no_same_outer_vals_large(self):
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(1820, 2, seed=1)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(2, 2389, seed=3)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "mul")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
